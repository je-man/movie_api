...
export class ProfileView extends React.Component {
  ...
  getUser(token) {
    ...
    axios
      .get(`https://ourflixapp.herokuapp.com/users/${username}`, {
  ...
  deleteFavoriteMovie(movieId) {
    ...
    axios
      .delete(
        `https://ourflixapp.herokuapp.com/users/${localStorage.getItem(
          'user'
        )}/Movies/${movieId}`,
        {
  ...
  deleteUser(e) {
    axios
      .delete(
        `https://ourflixapp.herokuapp.com/users/${localStorage.getItem('user')}`,
        {
          headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
        }
      )
